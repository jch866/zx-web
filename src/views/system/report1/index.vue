...
<template>
  <div class="main_box">
    ...
    <div class="table_wrap">
      ...
      <el-table :data="[]" style="width: 100%" header-row-class-name="table_header">
        <el-table-column prop="date" label="分行名称" width="150">
        </el-table-column>
        <el-table-column prop="date" label="分行梯队" width="150">
        </el-table-column>
        <el-table-column prop="date" label="分行大区" width="150">
        </el-table-column>
        <el-table-column prop="date" label="资产一分类" width="150">
        </el-table-column>
        <el-table-column prop="date" label="资产二分类" width="150">
        </el-table-column>
        <el-table-column label="资产规模数据(万元)">
          <el-table-column prop="date" label="期初存量" width="150">
          </el-table-column>
          <el-table-column prop="date" label="新增投放" width="150">
          </el-table-column>
          <el-table-column prop="date" label="投放到期" width="150">
          </el-table-column>
          <el-table-column prop="date" label="净投放" width="150">
          </el-table-column>
          <el-table-column prop="date" label="期未存量" width="150">
          </el-table-column>
        </el-table-column>
      ...
      <el-table :data="[]" style="width: 100%" header-row-class-name="table_header">
        ...
        <el-table-column prop="date" label="公司六⼤赛道" width="150">
        </el-table-column>
        <el-table-column prop="date" label="三分类" width="150">
        </el-table-column>
        <el-table-column label="资产规模数据(万元)">
          <el-table-column prop="date" label="期初存量" width="150">
          </el-table-column>
          <el-table-column prop="date" label="认/申购" width="150">
          </el-table-column>
          <el-table-column prop="date" label="赎回/到期" width="150">
          </el-table-column>
          <el-table-column prop="date" label="净认/申购" width="150">
          </el-table-column>
          <el-table-column prop="date" label="期末存量" width="150">
          </el-table-column>
          <el-table-column prop="date" label="期间均值" width="150">
          </el-table-column>
        </el-table-column>
